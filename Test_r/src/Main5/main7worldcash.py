...
Dependencies:
    pip install pygame requests requests-cache
...
# Install an offline cache so API data is downloaded once and then used in future runs.
try:
    import requests_cache
    requests_cache.install_cache('poke_cache', backend='sqlite', expire_after=None)
except ImportError:
    print("requests_cache not installed. Offline caching is disabled.")
...
class Game:
    ...
    def handle_main_menu(self):
        ...
        # Rearranged menu order as specified:
